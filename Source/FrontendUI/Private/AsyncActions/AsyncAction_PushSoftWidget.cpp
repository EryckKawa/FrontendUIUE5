...
{
	checkf(!InSoftWidgetClass.IsNull(), TEXT("PushSoftWidgetStack was passed a null soft widget class "));
...
void UAsyncAction_PushSoftWidget::Activate()
{
	...
	FrontendUISubsystem->PushSoftWidgetToStackAsync(CachedWidgetStackTag, CachedSoftWidgetClass, [this](EAsyncPushWidgetState InPushState, UWidget_ActivatableBase* PushedWidget)
	{
		switch (InPushState)
		{
